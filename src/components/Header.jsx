...
export default function Header() {
  return (
    ...
    <h1 className='font-bold text-sm sm:text-xl flex flex-wrap'>
        <span className='text-slate-500'>GharJagga</span>
        <span className='text-red'>Karobar</span>
      </h1></Link>
      ...
      <ul className='flex gap-4 '>
        ...
        <Link to='/sign-in'><li className='text-salte-700 hover:underline'>Sign in</li></Link>
        </ul>
      </div>
